  ...
  <div class="auth-container">
    ...
    <div class="auth-card glass-panel-premium animated-card">
      <div class="auth-header">
        ...
        <p class="auth-subtitle">Create your secure access profile</p>
      </div>
      ...
      <form @submit.prevent="handleRegister" class="auth-form">
        ...
        <button type="submit" class="btn-action btn-primary-glowing" :disabled="loading">
          ...
          <span>{{ loading ? 'Provisioning Account...' : 'Register Profile' }}</span>
        </button>
      </form>
      ...
      <div class="auth-footer">
        <p>
          ...
          <router-link to="/login" class="link-switch">Sign In</router-link>
        </p>
      </div>
    </div>
  </div>
...
async function handleRegister() {
  ...
  try {
    ...
    error.value = e.response?.data?.detail || 'Registration failed. Please check inputs.'
  } finally {
    loading.value = false
  }
}
